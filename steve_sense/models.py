...
class Attached_Devices(models.Model):
    ...
    device_duty_cycle = models.BooleanField(initial=False)
...
class Attached_Senors(models.Model):
    sensor_id = models.CharField(max_length=24, unique=True, primary_key=True)
    sensor_location = models.CharField(max_length=24)
    sensor_capabilities = models.JSONField()
...
class Environmental_Settings(models.Model):
    light_timer = models.BooleanField(initial=False)
    light_on = models.TimeField(blank=True, null=True)
    light_duration = models.DurationField(blank=True, null=True)
    light_intensity = models.BooleanField(initial=False)
    light_intensity_time_pattern = models.JSONField()
    light_rail = models.BooleanField(initial=False)
    auto_sync_rail = models.BooleanField(initial=False)
    light_rail_on = models.TimeField(blank=True, null=True)
    light_rail_duration = models.DurationField(blank=True, null=True)

    circulating_fans = models.BooleanField(initial=False)
    circulating_fans_time_pattern = models.JSONField()

    heating = models.BooleanField(initial=False)
    heating_target = models.IntegerField(default=20,validators=[MinValueValidator(0),MaxValueValidator(40)])
    heating_target_deviation = models.DecimalField(default=0.05,validators=[MinValueValidator(0),MaxValueValidator(0.5)])

    cooling = models.BooleanField(initial=False)
    cooling_target = models.IntegerField(default=20,validators=[MinValueValidator(0),MaxValueValidator(40)])
    cooling_target_deviation = models.DecimalField(default=0.05,validators=[MinValueValidator(0),MaxValueValidator(0.5)])

    extractor_timer = models.BooleanField(initial=False)
    extractor_time_pattern = models.JSONField()
    extractor_humidity_control_targeting = models.BooleanField(initial=False)
    ...
    extractor_differential_analysis = models.BooleanField(initial=False)
    differential_target_deviation = models.DecimalField(default=0.05,validators=[MinValueValidator(0),MaxValueValidator(0.5)])
    temperature_humidity_bias = models.DecimalField(default=0.05,validators=[MinValueValidator(0),MaxValueValidator(0.5)])
    ...
    differential_extractor_priority = models.BooleanField(initial=False)

    vpd_targeting = models.BooleanField(initial=False)
    vpd_target = models.DecimalField(default=0.05,validators=[MinValueValidator(0),MaxValueValidator(2)])
